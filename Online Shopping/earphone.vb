...
Public Class earphone
    ...
    Private Sub earphone_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        mainform.Show()
    End Sub

    Private Sub earphone_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cmbloader()
    End Sub
    ...
    Private Sub cmbloader()
        Try
            ...
            query = "select distinct brand from itemdb where type='earphone' "
    ...
    Private Sub model_loader()
        Try
            ...
            query = "select model from itemdb where brand='" + cmbBrand.Text + "' and type='earphone'"
            command = New SqlCommand(query, connection)
            Dim adapter As New SqlDataAdapter(command)
            Dim table As New DataTable()
            adapter.Fill(table)
    ...
    Private Sub btnCart_Click(sender As Object, e As EventArgs) Handles btnCart.Click
        ...
        cart.DataGridView1.Rows.Add("Earphone", cmbBrand.Text, cmbModel.Text, lblprice.Text, 1)
