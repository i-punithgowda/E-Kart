...
Public Class watch
    ...
    Private Sub watch_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        mainform.Show()
    End Sub

    Private Sub watch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cmbloader()
    End Sub
    Private Sub cmbloader()
        Try
            ...
            query = "select distinct brand from itemdb where type='watch' "
    ...
    Private Sub model_loader()
        Try
            ...
            query = "select model from itemdb where brand='" + cmbBrand.Text + "' and type='watch'"
            command = New SqlCommand(query, connection)
            Dim adapter As New SqlDataAdapter(command)
            Dim table As New DataTable()
            adapter.Fill(table)
    ...
    Private Sub BtnCart_Click(sender As Object, e As EventArgs) Handles BtnCart.Click
        ...
        cart.DataGridView1.Rows.Add("Watch", cmbBrand.Text, cmbModel.Text, lblprice.Text, 1)
