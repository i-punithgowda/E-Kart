...
Public Class dslr
    ...
    Private Sub dslr_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        mainform.Show()
    End Sub

    Private Sub dslr_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cmbloader()
    End Sub
    ...
    Private Sub cmbloader()
        Try
            ...
            query = "select distinct brand from itemdb where type='dslr' "
    ...
    Private Sub model_loader()
        Try
            ...
            query = "select model from itemdb where brand='" + cmbBrand.Text + "' and type='dslr'"
            command = New SqlCommand(query, connection)
            Dim adapter As New SqlDataAdapter(command)
            Dim table As New DataTable()
            adapter.Fill(table)
    ...
    Private Sub cartBtn_Click(sender As Object, e As EventArgs) Handles cartBtn.Click
        ...
        cart.DataGridView1.Rows.Add("Dslr", cmbBrand.Text, cmbModel.Text, lblprice.Text, 1)
