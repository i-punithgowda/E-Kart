...
Public Class Tv
    ...
    Private Sub Tv_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        mainform.Show()
    End Sub
    ...
    Private Sub cmbloader()
        Try
            ...
            query = "select distinct brand from itemdb where type='tv' "
    ...
    Private Sub model_loader()
        Try
            ...
            query = "select model from itemdb where brand='" + cmbBrand.Text + "' and type='tv'"
            command = New SqlCommand(query, connection)
            Dim adapter As New SqlDataAdapter(command)
            Dim table As New DataTable()
            adapter.Fill(table)
    ...
    Private Sub Btncart_Click(sender As Object, e As EventArgs) Handles Btncart.Click
        ...
        cart.DataGridView1.Rows.Add("Tv", cmbBrand.Text, cmbModel.Text, lblprice.Text, 1)
